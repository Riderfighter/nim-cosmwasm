...
/* Command for C compiler:
   /usr/bin/clang-15 -c -w -ferror-limit=3 --target=wasm32-unknown-unknown-wasm -I/usr/include -flto -fvisibility=hidden -nostdlib -fdata-sections -ffunction-sections -DPRINTF_DISABLE_SUPPORT_FLOAT=1 -DPRINTF_DISABLE_SUPPORT_LONG_LONG=1 -DPRINTF_DISABLE_SUPPORT_PTRDIFF_T=1 -Os  -fPIC  -I'/root/.choosenim/toolchains/nim-#devel/lib' -I/root/wasmrt -o /root/wasmrt/nimcache/@m..@s.choosenim@stoolchains@snim-@hdevel@slib@sstd@sassertions.nim.c.o /root/wasmrt/nimcache/@m..@s.choosenim@stoolchains@snim-@hdevel@slib@sstd@sassertions.nim.c */
...
struct tySequence__uB9b75OUPRENsBAu4AnoePA_Content { NI cap; tyObject_StackTraceEntry__oLyohQ7O2XOvGnflOss8EA data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NOINLINE(void, raiseAssert__stdZassertions_24)(NimStringV2 msg__wj7Y1v37uSXN8PiH9aPowyg);
...
{	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	...
	raiseExceptionEx((Exception*)T1_, "AssertionDefect", "raiseAssert", "/root/.choosenim/toolchains/nim-#devel/lib/std/assertions.nim", 29);
goto BeforeRet_;
	}BeforeRet_: ;
}
static N_INLINE(NIM_BOOL*, nimErrorFlag)(void) {
...
{nimErr_ = nimErrorFlag();
	raiseAssert__stdZassertions_24(msg__K3q0fL6aLKe9by6qIeCq9c1A);
